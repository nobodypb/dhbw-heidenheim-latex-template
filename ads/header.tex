...
\documentclass[
	pdftex,
  twoside,
  openright,   % New chapters on right side of book
  usegeometry,
	12pt,			    % fontsize
...
]{scrreprt}	                     % Koma-Script report-class, medium document: scrreprt, long document: scrbook
...
% Things for pandoc compatibility
